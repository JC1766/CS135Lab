...
(define (EuclidAlgo int1 int2)
  (if (= int2 0) int1 (EuclidAlgo int2 (modulo int1 int2))))
...
(define (Euclid-list int1 int2)
  (if (= int2 0) (list int1) (append (list int1) (Euclid-list int2 (modulo int1 int2)))))
...
(define (wj-help fillA fillB maxA maxB goal)
  (if (= fillB goal) (list(list fillA fillB))
      (if (= fillB maxB) (cons (list fillA fillB) (wj-help fillA 0 maxA maxB goal))
          (if (= fillA 0) (cons (list fillA fillB) (wj-help maxA fillB maxA maxB goal))
              (if (> (+ fillA fillB) maxB) (cons (list fillA fillB)(wj-help (-(+ fillA fillB) maxB) maxB maxA maxB goal))

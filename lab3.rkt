...
(define (nth n lst)
  (if (equal? lst '()) '() (if (= n 0) (car lst) (nth (- n 1) (cdr lst)))))
...
(define (map f lst)
  (if (equal? lst '()) '() (append (list(f (car lst))) (map f (cdr lst)))))
...
(define (filter pred lst)
  (if (equal? lst '()) '() (if (pred (car lst)) (append (list(car lst)) (filter pred (cdr lst))) (filter pred (cdr lst)))))
...
(define (product lst)
  (if (= (length lst) 0) 1 (* (car lst) (product (cdr lst)))))
